...
// Defining a constant for task file, tasks.json

define("TASKS_FILE", "tasks.json");

// Function for loading task from tasks.json
...
// Checking whether the form has been submitted using POST request
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    // TODO: Handle task addition (If the task is provided, then add it to the tasks array and save)
    if(isset($_POST['task']) && !empty(trim($_POST['task']))){ 
        ...
        // TODO: Handle task deletion (If a delete action is requested, remove the task from the array, and save)
        // delete a task
    ...
    <div class="container">
        <div class="task-card">
            ...
            <ul style="list-style: none; padding: 0;">
                <!-- Looping through tasks array and display each task with a toggle and delete option -->
